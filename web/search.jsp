    ...
    <div id="main">
        ...
        <div id="content">
            ...
            <div class="box">
                ...
                <c:forEach var="searchResult" items="${requestScope.get('search')}">
                    <!-- Movie -->
                    ...
                    <div class="movie">
                        ...
                        <div class="movie-image">
                            ...
                            <a href="/singlePost?id=${searchResult.id}"><span class="play"><span class="name">${searchResult.title}</span></span>
                                <img src="/getImage?picName=${searchResult.picture}" width="60"/>
                            </a>
                        </div>
